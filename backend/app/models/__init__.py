...
from app.models.collectors import WhoisRecord, SSLRecord, ScrapeRecord, KvKRecord, DnsHttpRecord, TechRecord, TrustmarkRecord, AdTrackerRecord, ScamCheckRecord
